...
<link rel="stylesheet" href="consul.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-gradient u-header u-header" id="sec-1562"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h3 class="u-text u-text-default u-text-grey-5 u-text-1">NoCry Team</h3>
      </div></header>
	...
	c4.6,0,8.3-3.7,8.3-8.3C160,76.1,159.1,74,157.5,72.3z"></path></svg>
        ...
        <h4 class="u-custom-font u-font-montserrat u-text u-text-default u-text-2">By. DmitryRansom</h4>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-21a0"><div class="u-align-left u-clearfix u-sheet u-sheet-1">
        <h4 class="u-text u-text-default u-text-1">Contato:<br>@DmitryRansom
        </h4>
        <h4 class="u-text u-text-default u-text-2">By. DmitryRansom</h4>
        <h3 class="u-text u-text-3">Junte-se a familia Kremlinbr | Telegram: @KREMLINBR | @KREMLINBRGROUP.</h3>
      </div></footer>
  </body>
</html>